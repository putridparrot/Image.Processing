...
[<Fact>]
let ``turn a picture into a two colour picture`` () =
    ...
    let twoTone = makeTwoTone (Color.Red.ToArgb() / 2) Color.White Color.Green pictures
    ...
    |> should equal (Color.Green.ToArgb())
